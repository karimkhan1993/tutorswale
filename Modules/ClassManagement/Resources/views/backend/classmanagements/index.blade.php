                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("classmanagement::text.name")
                            </th>
                            <th>
                                @lang("classmanagement::text.slug")
                            </th>
                            <th>
                                @lang("classmanagement::text.updated_at")
                            </th>
                            <th>
                                @lang("classmanagement::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("classmanagement::text.action")
                            </th>
                        </tr>
                    </thead>
