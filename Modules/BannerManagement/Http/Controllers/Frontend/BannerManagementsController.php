...
namespace Modules\BannerManagement\Http\Controllers\Frontend;

use App\Http\Controllers\Controller;
use Illuminate\Http\Response;
use Illuminate\Support\Str;

class BannerManagementsController extends Controller
{
    public $module_title;
    ...
    {
        // Page Title
        $this->module_title = 'BannerManagements';

        // module name
        $this->module_name = 'bannermanagements';

        // directory path of the module
        $this->module_path = 'bannermanagement::frontend';
