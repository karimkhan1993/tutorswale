                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("tutormanagement::text.name")
                            </th>
                            <th>
                                @lang("tutormanagement::text.slug")
                            </th>
                            <th>
                                @lang("tutormanagement::text.updated_at")
                            </th>
                            <th>
                                @lang("tutormanagement::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("tutormanagement::text.action")
                            </th>
                        </tr>
                    </thead>
