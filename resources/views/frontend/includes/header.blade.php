        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center content-center sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <a href="/">
                        <img class="hidden lg:block h-12 w-auto" src="{{asset('img/logo-with-text.png')}}" alt="{{ app_name() }}">
                    </a>
                </div>
...
<header class="header">
    ...
    <nav class="nav">
        ...
        <a href="{{ route('frontend.abutus') }}">{{__('About Us')}}</a>
        <!--<a href="#">One-To-One Class</a>-->
                    <div class="dropdown">
            <a href="#" class="toggle">One-To-One Class</a>
            <div class="dropdown-menu">
                <a href="{{ route('frontend.tutorsection') }}">{{__('Tutor Section')}}</a>
                <hr>
                <a href="{{ route('frontend.registration') }}">{{__('Apply as Tutor')}}</a>
            </div>
        </div>
